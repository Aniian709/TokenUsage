const REDIRECT_STORAGE_KEY = "tokenusage.dashboard.redirect.v1";
const POST_AUTH_PATH_STORAGE_KEY = "tokenusage.dashboard.post_auth_path.v1";
...
export function validateNextPath(value: any) {
  ...
  try {
    const url = new URL(trimmed, "https://tokenusage.local");
    if (url.origin !== "https://tokenusage.local") return null;
