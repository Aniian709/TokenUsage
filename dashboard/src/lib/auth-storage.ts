const STORAGE_KEY = "tokenusage.dashboard.auth.v1";
const SESSION_EXPIRED_KEY = "tokenusage.dashboard.session_expired.v1";
const SESSION_SOFT_EXPIRED_KEY = "tokenusage.dashboard.session_soft_expired.v1";
const AUTH_EVENT_NAME = "tokenusage:auth-storage";
