...
const VERSION_CACHE_KEY = "tokenusage.latest_tracker_version";
const VERSION_CACHE_AT_KEY = "tokenusage.latest_tracker_version_at";
const VERSION_TTL_MS = 6 * 60 * 60 * 1000;
const REGISTRY_URL = "https://registry.npmjs.org/tokenusage-cli/latest";
