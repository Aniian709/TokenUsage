...
function LocalIdentity({ collapsed }) {
  if (collapsed) {
    return (
      <div className="flex h-9 w-9 items-center justify-center rounded-md border border-oai-gray-200 dark:border-oai-gray-800 bg-oai-gray-100 dark:bg-oai-gray-900">
        <img src="/app-icon.png" alt="" width={20} height={20} className="h-5 w-5 rounded" />
      </div>
    );
  }
 ...
 */
function StarPill({ repo = "Aniian709/TokenUsage", glassChrome = false }) {
        ...
        {showCloseButton ? (
          <div className="flex items-center gap-2">
            <div className="flex-1 min-w-0">
              <LocalIdentity collapsed={collapsed} />
            </div>
            <button
              type="button"
              onClick={onClose}
