...
function printHelp() {
  ...
  process.stdout.write(
    [
      ...
      "",
      "Usage:",
      "  npx tokenusage                                           Open local dashboard",
      "  npx tokenusage [--debug] serve [--port 7680] [--no-open] [--no-sync]",
      "  npx tokenusage [--debug] init [--yes] [--dry-run] [--no-open] [--link-code <code>]",
      "  npx tokenusage [--debug] sync [--auto] [--drain] [--from-openclaw]",
      "  npx tokenusage [--debug] status [--probe-keychain] [--probe-keychain-details]",
      "  npx tokenusage [--debug] diagnostics [--out diagnostics.json]",
      "  npx tokenusage [--debug] doctor [--json] [--out doctor.json] [--base-url <url>]",
      "  npx tokenusage [--debug] uninstall [--purge]",
      "",
      "Notes:",
